...
# Plot the results
plt.figure()
plt.scatter(X[:, 0], y, s=20, edgecolor="black",
            c="darkorange", label="train data")
plt.scatter(x_test[:, 0], model.predict(x_test), s=30,
            color="yellowgreen", label="test data", linewidth=2)
...
plt.figure()
plt.scatter(X[:, 1], y, s=20, edgecolor="black",
            c="darkorange", label="train data")
plt.scatter(x_test[:, 1], model.predict(x_test), s=30,
            color="yellowgreen", label="test data", linewidth=2)
...
plt.figure()
plt.scatter(X[:, 2], y, s=20, edgecolor="black",
            c="darkorange", label="train data")
plt.scatter(x_test[:, 2], model.predict(x_test), s=30,
            color="yellowgreen", label="test data", linewidth=2)
